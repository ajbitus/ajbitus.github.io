  ...
  return (
    <Navbar variant={toString()} fixed="top" collapseOnSelect expand="md">
      <Navbar.Brand className="pl-5 ml-5" as={Link} to="/">
        <Image
          height="40"
          src={dark ? `../../icons/min-logo-dark.svg` : `../../icons/min-logo-light.svg`}
          alt={"AJbitus"}
        />
        <Image
          height="40"
          src={dark ? `../../icons/max-logo-dark.svg` : `../../icons/max-logo-light.svg`}
          alt={"AJbitus"}
        />
      </Navbar.Brand>
      ...
      >
        <Nav className="pr-3 mr-4 nav-links">
          ...
          <Nav.Link className="ml-2" as={Link} to="/profile" title="Profile">
            Profile
          </Nav.Link>
